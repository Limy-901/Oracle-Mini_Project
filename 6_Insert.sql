...
-- 알림
insert into NOTICE(NEW_NOTICE) values('20-12 공지사항');
insert into NOTICE(NEW_EVENT) values('친구 추천 이벤트');
insert into NOTICE(NEW_NOTICE) values('20-12 업데이트');
insert into NOTICE(NEW_EVENT) values('친구 추천 이벤트, 두번째!');
